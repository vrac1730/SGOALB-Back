    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            context.Productos.AddOrUpdate(x => x.id,
                ...
                new Producto() { id = 7, codigo = "117", nombre = "Lapicero", descripcion = "Lapicero de buena calidad", marca = "Pilot", stock_min = 10, stock_max = 50, cantidad = 7, idCategoria = 2, idAlerta = 4 },
                new Producto() { id = 8, codigo = "118", nombre = "Papelografo", descripcion = "Pepelografo cuadriculado", marca = "Justus", stock_min = 10, stock_max = 50, cantidad = 5, idCategoria = 2, idAlerta = 4 },
                new Producto() { id = 9, codigo = "119", nombre = "Papelografo", descripcion = "Pepelografo en blanco", marca = "Dragon", stock_min = 10, stock_max = 50, cantidad = 9, idCategoria = 2, idAlerta = 4 }
                );


            context.ProductosxAlmacen.AddOrUpdate(x => x.id,
              new ProductoxAlmacen() { id = 1, fecha_ingreso = new DateTime(2021, 06, 12, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 47, idAlmacen = 1, idProducto = 1, idEstado = 1, idAlerta = 3 },
              new ProductoxAlmacen() { id = 2, fecha_ingreso = new DateTime(2021, 06, 09, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 45, idAlmacen = 1, idProducto = 2, idEstado = 2, idAlerta = 3 },
              new ProductoxAlmacen() { id = 3, fecha_ingreso = new DateTime(2021, 06, 20, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 30, idAlmacen = 1, idProducto = 3, idEstado = 2, idAlerta = 2 },
              new ProductoxAlmacen() { id = 4, fecha_ingreso = new DateTime(2021, 06, 03, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 21, idAlmacen = 1, idProducto = 4, idEstado = 3, idAlerta = 2 },
              new ProductoxAlmacen() { id = 5, fecha_ingreso = new DateTime(2021, 06, 17, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 10, idAlmacen = 1, idProducto = 5, idEstado = 3, idAlerta = 1 },
              new ProductoxAlmacen() { id = 6, fecha_ingreso = new DateTime(2021, 06, 30, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 7, idAlmacen = 1, idProducto = 6, idEstado = 3, idAlerta = 1 },
              new ProductoxAlmacen() { id = 7, fecha_ingreso = new DateTime(2021, 06, 14, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 43, idAlmacen = 1, idProducto = 7, idEstado = 3, idAlerta = 3 },
              new ProductoxAlmacen() { id = 8, fecha_ingreso = new DateTime(2021, 06, 14, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 40, idAlmacen = 1, idProducto = 8, idEstado = 3, idAlerta = 3 },
              new ProductoxAlmacen() { id = 9, fecha_ingreso = new DateTime(2021, 06, 14, 12, 19, 20), fecha_salida = new DateTime(2021, 06, 03, 15, 19, 20), cantidad = 49, idAlmacen = 1, idProducto = 9, idEstado = 3, idAlerta = 3 }
              );
