...
namespace SGOALB_BACK.Controllers
{
    public class AlmacenController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,cantidad,fecha_ingreso,fecha_salida,direccion")] Almacen almacen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,cantidad,fecha_ingreso,fecha_salida,direccion")] Almacen almacen)
        {
            if (ModelState.IsValid)
            {
